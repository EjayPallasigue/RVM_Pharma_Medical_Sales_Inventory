...
<head>
    <meta charset="utf-8" />
    <title>RVM Inventory & Sales Management System</title>
...
<body>
        ...
        <div class="container">
            ...
            <div id="navbar" class="collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="<?php echo base_url(); ?>ShowForm/create_medicine_name/main">Create Options</a></li>
                    ...
                    <li><a href="<?php echo base_url(); ?>ShowForm/manage_staff/main">Manage Staff Account</a></li>
                </ul>
    ...
    <header id="header" style="background-color: #151E3D;">
        <div class="container">
            <div class="col-md-10">
                <h2>
